...
export function withI18n(
  { permanent, localeParam, ...custom }: MergedConfig = {
    i18n: {
      locales: ["en"],
      defaultLocale: "en",
  ...
  let nextConfig: NextConfig = custom;
  ...
  return withTranslate(newNextConfig) as Omit<NextConfig, "i18n"> & {
    i18n: Required<NextConfig["i18n"]>;
  };
}
