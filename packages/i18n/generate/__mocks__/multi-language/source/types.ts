...
export namespace I18n.RouteParams {
  export interface AccountUserId {
    id: string | number;
  }
  export interface AppsToolSpa {
    spa: string | number;
  }
  export interface AppsToolThingsId {
    id: string | number;
  }
  export interface AppsToolThingsIdDetail {
    id: string | number;
  }
  export interface AppsToolThingsIdDetailDetailId {
    id: string | number;
    detailId: string | number;
  }
  export interface AppsToolThingsIdDetailDetailIdEdit {
    id: string | number;
    detailId: string | number;
  }
  export interface AppsToolThingsIdDetailNew {
    id: string | number;
  }
  export interface ProductsId {
    id: string | number;
  }
  export interface ProductsIdEdit {
    id: string | number;
  }
  export interface ProductsIdEditDetails {
    id: string | number;
  }
}
...
export namespace I18n {
   ...
   */
  export type TranslateNamespace = Extract<
