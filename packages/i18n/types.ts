...
export namespace I18n {
  ...
  export type RouteUrl = string & { __routeUrl: true };

  /**
   * The `routes.json` map generated by `knitkode/koine/actions/i18n` in {@link "./generate/generateRoutes.ts"}
   *
   * This is a loose type, the actual Records are as in {@link RoutesMapStrict}:
   *
   * ```ts
   * Record<RouteId, Record<Locale, RouteUrl>>
   * ```
   */
   ...
   * {@link RoutesMap}
   */
  export type RoutesMapStrict = Record<RouteId, Record<Locale, RouteUrl>>;
