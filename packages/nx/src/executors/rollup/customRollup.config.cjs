...
//  * @param {import("@nx/rollup").RollupExecutorOptions} options  TODO: find type
//  * @param {import("@nx/devkit").ExecutorContext} context
//  * @returns
//  */
// function pluginNxTds(/* nxRollupConfig: any,  */ options, context) {
...
//         // rollupPluginTs(),
//         pluginNxTds(nxRollupConfig, options, this),
//       ],
//     };
//     // return {
//     //     ...nxConfig,
