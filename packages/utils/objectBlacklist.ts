/**
 * Blacklist an object properties by removing the given keys, it returns a
 * new object.
 *
 ...
 * @category objects
 */
export function objectBlacklist<T extends object, Keys extends (keyof T)[]>(
  object: T,
  keys: Keys
) {
...
export default objectBlacklist;
