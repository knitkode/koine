            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all(relativePaths.map(function (relativePath) { return __awaiter(_this, void 0, void 0, function () {
                            var dir, ext, fileName, srcFile, destFile, destDir, destEsmDir, destCjsDir;
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                    ...
                                    case 2:
                                        ...
                                        if (fileName === "index" && dir && dir !== ".") {
                                            ...
                                            destEsmDir = destDir;
                                            destCjsDir = (0, path_1.join)(outputPath, "/".concat(BUNDLE_TYPE_COMMONJS, "/"), dir);
                                            entrypointsDirs.push(dir);
                                            (0, devkit_1.writeJsonFile)((0, path_1.join)(destDir, "./package.json"), getPackageJsonData(destDir, destEsmDir, destCjsDir));
                                        }
                                        return [2 /*return*/];
                                }
                            });
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    entrypointsDirs = [];
                    return [4 /*yield*/, (0, glob_1.glob)("**/*.{js,json,ts}", { cwd: tmpPath })];
                case 1:
                    relativePaths = _a.sent();
                    return [4 /*yield*/, Promise.all(relativePaths.map(function (relativePath) { return __awaiter(_this, void 0, void 0, function () {
...
function manageTsConfig(options, context, bundleType) {
    var _a = getConfigFilePathTsc(options, context, bundleType), src = _a.src, dest = _a.dest, destRelative = _a.destRelative;
...
function manageSwcrc(options, context, bundleType) {
    var _a = getConfigFilePathSwc(options, context, bundleType), src = _a.src, dest = _a.dest, destRelative = _a.destRelative;
...
function getConfigFilePathSwc(options, context, bundleType) {
    var srcRelative = options.swcrc || options.tsConfig.replace("tsconfig.lib.json", ".swcrc");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    handleTermination = function () {
                        for (var i = 0; i < bundleTypes.length; i++) {
                            ...
                            var destTsconfig = getConfigFilePathTsc(options, context, bundleType).dest;
                            var destSwcrc = getConfigFilePathSwc(options, context, bundleType).dest;
                            (0, fs_extra_1.removeSync)(destTsconfig);
                            if (custom.swcrc)
                                (0, fs_extra_1.removeSync)(destSwcrc);
                            if (bundleType !== DEFAULT_BUNDLE_TYPE) {
                    ...
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues((0, swc_impl_1.swcExecutor)(__assign(__assign({}, options), custom), context))))];
                case 3: return [4 /*yield*/, __await.apply(void 0, [_a.sent()])];
                case 4:
                    _a.sent();
                    return [3 /*break*/, 8];
                case 5: return [5 /*yield**/, __values(__asyncDelegator(__asyncValues((0, tsc_impl_1.tscExecutor)(__assign(__assign({}, options), custom), context))))];
                ...
                case 8:
                    ...
                    return [5 /*yield**/, __values(__asyncDelegator(__asyncValues((0, tsc_impl_1.tscExecutor)(__assign(__assign({}, options), custom), context))))];
